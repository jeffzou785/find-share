...
| **医药量价齐升** | 重构为二A“集采修复型”和二B“创新药/创新器械出海型”；已新增行业池分类、ground truth 规则和港股代码映射骨架 | 规划中 |
...
| `global_stock_mapping` | 港股/A+H 代码格式归一，输出 Yahoo/东财 `SECUCODE`/`secid` | `global_stock_mapping.py` |
